...
ComputeStyle(inter/molc,ComputeInterMolc)

#else

#ifndef LMP_COMPUTE_INTER_MOLC_H
#define LMP_COMPUTE_INTER_MOLC_H
...
class ComputeInterMolc : public Compute {
 public:
  ComputeInterMolc(class LAMMPS *, int, char **);
  ~ComputeInterMolc();
  void init();
